 ...
 * others play {@link #ORDERING_SEQUENTIAL}. For example, {@link android.backport.transition.AutoTransition}
 * uses a TransitionSet to sequentially play a Fade(Fade.OUT), followed by
 * a {@link android.backport.transition.ChangeBounds}, followed by a Fade(Fade.OUT) transition.
 *
 ...
 * </pre>
 */
public class TransitionSet extends android.backport.transition.Transition {

    ArrayList<android.backport.transition.Transition> mTransitions = new ArrayList<android.backport.transition.Transition>();
     ...
     * set by calling {@link #addTransition(android.backport.transition.Transition)} )}. By default,
     ...
     * @return This transitionSet object.
     */
    public TransitionSet addTransition(android.backport.transition.Transition transition) {
        if (transition != null) {
     ...
     * @return This transitionSet object.
     */
    public TransitionSet removeTransition(android.backport.transition.Transition transition) {
    ...
    private void setupStartEndListeners() {
        ...
        for (android.backport.transition.Transition childTransition : mTransitions) {
    ...
    static class TransitionSetListener extends TransitionListenerAdapter {
        ...
        @Override
        public void onTransitionStart(android.backport.transition.Transition transition) {
    ...
    protected void runAnimators() {
        ...
        if (!mPlayTogether) {
            ...
            for (int i = 1; i < mTransitions.size(); ++i) {
                android.backport.transition.Transition previousTransition = mTransitions.get(i - 1);
                final android.backport.transition.Transition nextTransition = mTransitions.get(i);
            ...
            android.backport.transition.Transition firstTransition = mTransitions.get(0);
    ...
    public TransitionSet clone() {
        ...
        clone.mTransitions = new ArrayList<android.backport.transition.Transition>();
        int numTransitions = mTransitions.size();
        for (int i = 0; i < numTransitions; ++i) {
            clone.addTransition((android.backport.transition.Transition) mTransitions.get(i).clone());
        }
        return clone;
    }
