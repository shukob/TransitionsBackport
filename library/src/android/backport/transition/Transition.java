 ...
 * choreograph several child transitions ({@link android.backport.transition.TransitionSet} or they may
 * perform custom animations themselves. Any Transition has two main jobs:
 * (1) capture property values, and (2) play animations based on changes to
 * captured property values. A custom transition knows what property values
 * on View objects are of interest to it, and also knows how to animate
 * changes to those values. For example, the {@link android.backport.transition.Fade} transition tracks
 ...
 * specific transitions (such as {@link android.backport.transition.Fade}) may not be compatible
 ...
 * For example, here is a minimal resource file that declares a {@link android.backport.transition.ChangeBounds} transition:</p>
 *
 ...
 * elaborate example which declares a {@link android.backport.transition.TransitionSet} transition with
 * {@link android.backport.transition.ChangeBounds} and {@link android.backport.transition.Fade} child transitions:</p>
 *
 * {@sample
 ...
 * object to change from the default {@link android.backport.transition.TransitionSet#ORDERING_TOGETHER} behavior
 * to be {@link android.backport.transition.TransitionSet#ORDERING_SEQUENTIAL} instead. Also, the {@link android.backport.transition.Fade}
 * transition uses a fadingMode of {@link android.backport.transition.Fade#OUT} instead of the default
 ...
 * disappearing, so we choose to limit the {@link android.backport.transition.Fade} transition to only that view.</p>
 *
...
public abstract class Transition implements Cloneable {
    ...
    /**
     * Returns the set of property names used stored in the {@link android.backport.transition.TransitionValues}
     * object passed into {@link #captureStartValues(android.backport.transition.TransitionValues)} that
     ...
     * {@link android.backport.transition.TransitionValues}. The default implementation returns <code>null</code>.
     */
     ...
     * Transition is a {@link android.backport.transition.TransitionSet} consisting of several
     ...
     * stored in the {@link android.backport.transition.TransitionValues#view} field.</p>
     *
     *
     ...
     * and calls {@link #createAnimator(android.view.ViewGroup, android.backport.transition.TransitionValues, android.backport.transition.TransitionValues)}
     ...
     * {@link #createAnimator(android.view.ViewGroup, android.backport.transition.TransitionValues, android.backport.transition.TransitionValues)}.
     ...
     *
     * @see #captureEndValues(android.backport.transition.TransitionValues)
     * @see #createAnimator(android.view.ViewGroup, android.backport.transition.TransitionValues, android.backport.transition.TransitionValues)
     */
     ...
     * the transitionValues structure when this method is called.
     *
     * @see #captureStartValues(android.backport.transition.TransitionValues)
     * @see #createAnimator(android.view.ViewGroup, android.backport.transition.TransitionValues, android.backport.transition.TransitionValues)
     */
     ...
     * android.backport.transition.Transition.TransitionListener#onTransitionPause(android.backport.transition.Transition)} to all listeners
...
//                    anim.resume(); // TODO
     ...
     * {@link android.backport.transition.Transition#createAnimator(android.view.ViewGroup, android.backport.transition.TransitionValues,
     * android.backport.transition.TransitionValues)}) or because the transition returned a valid
    ...
    public static interface TransitionListener {
         ...
         * events. That is, {@link #onTransitionEnd(android.backport.transition.Transition)} is always called,
         ...
         * Note that cancel may be called by a parent {@link android.backport.transition.TransitionSet} on
         ...
         * Note that createAnimator() may be called by a parent {@link android.backport.transition.TransitionSet} on
         * a child transition which has not yet started. This allows the child
         * transition to restore state on target objects which was set at
         * {@link #createAnimator(android.view.ViewGroup, android.backport.transition.TransitionValues, android.backport.transition.TransitionValues)
         * createAnimator()} time.
         ...
         * Note that resume() may be called by a parent {@link android.backport.transition.TransitionSet} on
         * a child transition which has not yet started. This allows the child
         * transition to restore state which may have changed in an earlier call
         * to {@link #onTransitionPause(android.backport.transition.Transition)}.
         *
