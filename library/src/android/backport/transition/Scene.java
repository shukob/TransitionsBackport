...
public final class Scene {
     ...
     * created by the caching factory method {@link android.backport.transition.Scene#getCurrentScene(android.view.View)}.</p>
     *
     * @param sceneRoot The root of the hierarchy in which scene changes
     * and transitions will take place.
    ...
    /**
     * Gets the current {@link android.backport.transition.Scene} set on the given view. A scene is set on a view
     ...
     * @see android.backport.transition.Scene#Scene(android.view.ViewGroup, int, android.content.Context)
     * @see android.backport.transition.Scene#Scene(android.view.ViewGroup, android.view.ViewGroup)
     */
